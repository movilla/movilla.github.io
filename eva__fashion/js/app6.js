...
var predestino = document.getElementById('respuesta');
predestino.innerHTML = '<article><a id="texto_int" class="txt_intro_explicacion_cuater" href="./index_7.html">JAjaajajaj YES!!! Pincha en el relago para ver tu regalo<img  id="icon_dest" class="icono_destino_2" data-arriba="si" src="./style/img/regalo_2_.webp"></a></article>';
}
