                    ...
                    data:[
                        {
                            ...
                            by:{
                                ...
                                ES:"Inspirado en la aventura de MD2 Darkbringer Pack \"The Scorpion King\""
                            },
                                                ...
                                                guardian:[
                                                    {
                                                        ...
                                                        ES:[ "el Guardi&aacute;n", "por el Guardi&aacute;n", "ha sido corrompido", "afrontarlo", "detenerlo", "combatirlo", "enfrentarlo" ]
                                                    },{
                                                        ...
                                                        ES:[ "la Centinela", "por la Centinela", "ha sido corrompida", "afrontarla", "detenerla", "combatirla", "enfrentarla" ]
                                                    },{
                                                        ...
                                                        ES:[ "el Oscuro", "por el Oscuro", "ha sido corrompido", "afrontarlo", "detenerlo", "combatirlo", "enfrentarlo" ]
                                                    }
                                                ],
                                                corruption:[
                                                    {
                                                        ...
                                                        ES:[ "{label.guardian@2} m&aacute;s all&aacute; de todo l&iacute;mite por el" ]
                                                    },{
                                                        IT:[ "non ha resistito al controllo degli" ],
                                                        EN:[ "has not resisted the control of the" ],
                                                        ES:[ "no ha podido resistirse al control del" ]
                                                    },{
                                                        IT:[ "&egrave; sotto il controllo degli" ],
                                                        EN:[ "is under the control of the" ],
                                                        ES:[ "est&aacute; bajo el control del" ]
                                                    }
                                                ],
                                                by:[
                                                    {
                                                ...
                                                unstoppable:[
                                                    {
                                                        ...
                                                        ES:[ "Nadie tiene el valor de {label.guardian@3}. Pero los H&eacute;roes no pueden echarse atr&aacute;s..." ]
                                                    }
                                                ],
                                                plan:[
                                                    {
                                                        ...
                                                        ES:[ "{label.guardian:capital@5} en su propia guarida", "En Su Propia Guarida" ]
                                                    },{
                                                        ...
                                                        ES:[ "{label.guardian:capital@6} en su propio escondite", "En Su Propio Escondite" ]
                                                    },{
                                                        IT:[ "Un attacco diretto", "Un attacco diretto" ],
                                                        EN:[ "A direct attack", "A direct attack" ],
                                                        ES:[ "Un ataque directo", "Un ataque directo" ]
                                                    }
                                                ],
                                                effect:[
                                                    {
                                                        ...
                                                        ES:[ "es la &uacute;nica forma de acabar con su cruel dominio" ]
                                                    },{
                                                        ...
                                                        ES:[ "es la &uacute;nica forma de poner fin a su influjo mortal" ]
                                                    },{
                                                        ...
                                                        ES:[ "es la &uacute;nica soluci&oacute;n. Los H&eacute;roes deben frenar el mal" ]
                                                    }
                                                ],
                                                effect2:[
                                                    {
                                                ...
                                                collectOptionalItems:[
                                                    {
                                                        ...
                                                        ES:[ "eliminar todas las Cuadrillas Corruptas", "eliminando {label.collectOptionalItems@3} Cuadrillas Corruptas", "{tokensCount.corruption}" ]
                                                    }
                                                ]
                                            }
                                        ]
                                    ...
                                    story:[
                                        {
                                            ...
                                            ES:"{label.guardian:capital@0} {label.corruption@0} {label.by@0} {label.then@0}. {label.unstoppable@0} {label.plan@0} {label.effect@0} {label.effect2@0}"
                                        }
                                    ],
                                    objectivesHeader:[
                                        {
                                                ...
                                                name:[
                                                    {
                                                        ...
                                                        ES:"Poner Fin a la Amenaza Corrupta"
                                                    }
                                                ],
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Elimina {label.collectOptionalItems@2} Cuadrillas Corruptas",
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        EN:
                                                            ...
                                                            ES:"Los marcadores de Corrupci&oacute;n {symbol.corruptionToken} en las C&aacute;maras representan {label.collectOptionalItems@2} Cuadrillas que han sido corrompidas {label.guardian@1}. Cuando un H&eacute;roe revela una C&aacute;mara que contiene un marcador de Corrupci&oacute;n {symbol.corruptionToken}, despu&eacute;s de resolver la carta de Puerta, genera una Cuadrilla en la Zona del marcador de Corrupci&oacute;n {symbol.corruptionToken} y coloca ese marcador sobre la carta de la Cuadrilla." + "<p>Una Cuadrilla con un marcador de Corrupci&oacute;n {symbol.corruptionToken} es una Cuadrilla Corrupta. Tiene la siguiente habilidad adem&aacute;s de cualquier otra: <span class='phase'>Combate</span>: +1{symbol.scratch}.</p>" + "<p>Cuando una Cuadrilla Corrupta es eliminada, cada H&eacute;roe gana 8 PE en lugar de los 2 PE habituales.</p>"
                                                    }
                                                ],
                                                campaignExplanation:[
                                                    {
                                                ...
                                                miniCampaignExplanation:[
                                                    {
                                                        ...
                                                        EN:
                                                            ...
                                                            ES:"Los marcadores de Corrupci&oacute;n {symbol.corruptionToken} en las C&aacute;maras representan {label.collectOptionalItems@2} Cuadrillas que han sido corrompidas {label.guardian@1}. Cuando un H&eacute;roe revela una C&aacute;mara que contiene un marcador de Corrupci&oacute;n {symbol.corruptionToken}, despu&eacute;s de resolver la carta de Puerta, genera una Cuadrilla en la Zona del marcador de Corrupci&oacute;n {symbol.corruptionToken} y coloca ese marcador sobre la carta de la Cuadrilla." + "<p>Una Cuadrilla con un marcador de Corrupci&oacute;n {symbol.corruptionToken} es una Cuadrilla Corrupta. Tiene la siguiente habilidad adem&aacute;s de cualquier otra: <span class='phase'>Combate</span>: +1{symbol.scratch}. Cuando es derrotada, todos los H&eacute;roes ganan {label.miniCampaignObjectivesXp:split:tokensCount.corruption} PE.</p>"
                                                    }
                                                ]
                                            }
                                        ],[
