            ...
            content:[
                {
                    ...
                    data:{
                        objectives:{
                            ...
                            EN:"Quest objectives",
                            ES:"Objetivos de la misi&oacute;n"
                        },
                        specialRules:{
                            IT:"Regole speciali",
                            EN:"Quest special rules",
                            ES:"Reglas especiales de la misi&oacute;n"
                        },
                        challenges:{
                            IT:"Sfide",
                            EN:"Challenges",
                        ...
                        challengesExplanation:{
                            ...
                            ES:"Si buscas peligro y gloria, puedes afrontar esta aventura siguiendo una o m&aacute;s de estas reglas adicionales:"
                        },
                        requiredTiles:{
                            IT:"Tessere richieste",
                            EN:"Tiles needed",
                            ES:"Losetas necesarias"
                        },
                        upTo:{
                            IT:"Fino a",
                            EN:"Up to",
                        ...
                        lootRatio:{
                            ...
                            ES:"Los marcadores de Bot&iacute;n se colocan seg&uacute;n el n&uacute;mero de H&eacute;roes:"
                        },
                        questHeader:{
                        ...
                        questFooter:{
                            ...
                            ES:"Massive Randomness 2 &dash; Aventura Individual"
                        },
                        showHiddenText:{
                            IT:"Mostra testo nascosto",
                            EN:"Show hidden text",
                            ES:"Mostrar texto oculto"
                        },
                        massiveDarkness1:{
                            EN:"from Massive Darkness 1",
                            ES:"de Massive Darkness 1",
                        ...
                        zombicideTiles:[
                            {
                                ...
                                explanation:{
                                    ...
                                    ES:"Las losetas de Zombicide (indicadas con <b>[Z]</b>) deben considerarse divididas en 3&times;3 Zonas, igual que las losetas de Massive Darkness. Los edificios equivalen a las C&aacute;maras de Massive Darkness 2, y los muros en los bordes de una loseta o entre una Zona de edificio y una Zona de calle se consideran siempre cerrados, a menos que haya un marcador de Puerta. Las losetas de Zombicide est&aacute;n ambientadas en el exterior, por lo que las Zonas de calle se consideran Zonas de Luz y las Zonas de edificios se consideran Zonas de Sombra."
                                }
                            }
                        ],
                        zombicideHedges:[
                            {
                                ...
                                explanation:{
                                    ...
                                    ES:"Los obst&aacute;culos (setos, puentes, etc.) impresos en las losetas pueden cruzarse con normalidad, pero interrumpen las L&iacute;neas de Visi&oacute;n de H&eacute;roes y Enemigos."
                                }
                            }
                        ],
                        zombicideWater:[
                            {
                                ...
                                explanation:{
                                    ...
                                    ES:"Enemigos y H&eacute;roes se mueven con normalidad por las Zonas Anegadas, pero deben gastar 1 PM adicional para salir de una Zona Anegada a trav&eacute;s de una cornisa."
                                }
                            }
                        ],
                        zombicideSolidWalls:[
                            {
                                ...
                                explanation:{
                                    ...
                                    EN:"Tower tiles feature both building and street Zones, bordered by ramparts:<ul>"+
                                        ...
                                        "</ul>",
                                        ES:"Las losetas de torre contienen tanto Zonas de edificio como Zonas de calle, delimitadas por bastiones:<ul><li>Los bastiones no pueden cruzarse, pero no bloquean las L&iacute;neas de Visi&oacute;n.</li><li>Es posible disparar a trav&eacute;s de los bastiones.</li><li>Un H&eacute;roe o Enemigo en la Zona de una torre puede ver por encima de un edificio, hasta las Zonas m&aacute;s all&aacute; de &eacute;l. Del mismo modo, cualquier H&eacute;roe o Enemigo en una de esas Zonas tiene L&iacute;nea de Visi&oacute;n hasta el H&eacute;roe o Enemigo situado en la torre.</li><li>Un H&eacute;roe puede disparar desde la Zona de una torre por encima de una Zona de edificio. La Zona de edificio atravesada por el disparo cuenta a efectos del alcance del arma o hechizo, pero no est&aacute; alcanzada por una L&iacute;nea de Visi&oacute;n.</li><li>No es posible trazar L&iacute;neas de Visi&oacute;n entre las Zonas de torre delimitadas por bastiones y las Zonas de edificio adyacentes a ellas, ni siquiera si hay una puerta abierta.</li></ul>"
                                }
                            }
                        ]
                    }
