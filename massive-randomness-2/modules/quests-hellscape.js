                    ...
                    data:[
                        {
                            ...
                            objective:{
                                ...
                                ES:"Los H&eacute;roes, separados, deben reunirse en una zona y derrotar a un Monstruo Errante para ganar."
                            },
                            by:{
                                IT:"Ispirato all'avventura di Hellscape \"Hellscape\"",
                                EN:"Inspired by the Hellscape quest \"Hellscape\"",
                                ES:"Inspirado en la misi&oacute;n de Hellscape \"Hellscape\""
                            },
                                                ...
                                                problem:[
                                                    {
                                                        ...
                                                        ES:[ "&iexcl;Algo sali&oacute; mal con el &uacute;ltimo portal! Nos hemos perdido y" ]
                                                    },{
                                                        ...
                                                        ES:[ "No recordamos qu&eacute; pas&oacute;. En cuanto abrimos los ojos de nuevo, nos dimos cuenta de que" ]
                                                    },{
                                                        IT:[ "Quella di separarci nella foresta non &egrave; stata una buona idea..." ],
                                                        EN:[ "Separating us in the forest wasn't a good idea..." ],
                                                        ES:[ "Separarnos en el bosque no fue una buena idea..." ]
                                                    }
                                                ],
                                                lost:[
                                                    {
                                                        ...
                                                        ES:[ "&iexcl;ahora estamos separados los unos de los otros!", "&iexcl;Separados!" ]
                                                    },{
                                                        ...
                                                        ES:[ "&iexcl;alguna fuerza misteriosa debe habernos separado!", "La Fuerza Misteriosa" ]
                                                    },{
                                                        IT:[ "non capiamo dove siamo finiti!", "Dove siamo finiti?" ],
                                                        EN:[ "we don't understand where we ended up!", "Where have we ended up?" ],
                                                        ES:[ "&iexcl;no entendemos d&oacute;nde hemos acabado!", "&iquest;D&oacute;nde hemos acabado?" ]
                                                    }
                                                ],
                                                guard:[
                                                    {
                                                        ...
                                                        ES:[ "Hay un Monstruo Errante vigilando la &uacute;nica salida" ]
                                                    },{
                                                ...
                                                gate:[
                                                    {
                                                        ...
                                                        ES:[ "Portal Arcano", "Portales Arcanos", "los", "un", "su portal", "&uacute;nicamente su propio portal" ]
                                                    },{
                                                        ...
                                                        ES:[ "Teletransportador", "Teletransportadores", "los", "un", "su teletransportador", "&uacute;nicamente su propio teletransportador" ]
                                                    },{
                                                        ...
                                                        ES:[ "Espejo Encantado", "Espejos Encantados", "los", "un", "su espejo", "&uacute;nicamente su propio espejo" ]
                                                    }
                                                ],
                                                cliffhanger:[
                                                    {
                                    ...
                                    title:[
                                        {
                                            ...
                                            ES:"{label.cliffhanger@0}"
                                        },{
                                            EN:"{label.gate:capital@2} {label.gate:capital@1}",
                                            ES:"{label.gate:capital@2} {label.gate:capital@1}"
                                        },{
                                            EN:"{label.lost:capital@1}",
                                            ES:"{label.lost:capital@1}"
                                        }
                                    ],
                                    story:[
                                        {
                                            EN:"{label.problem@0} {label.lost@0} {label.guard@0} {label.avoid@0} {label.objective@0} {label.goal@0}",
                                            ES:"{label.problem@0} {label.lost@0} {label.guard@0} {label.avoid@0} {label.objective@0} {label.goal@0}"
                                        }
                                    ],
                                    objectivesHeader:[
                                        {
                                                ...
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Todos los H&eacute;roes deben alcanzar la Loseta {tileLabel.center}"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Derrotar al Monstruo Errante Final"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"En esta Misi&oacute;n, los H&eacute;roes empiezan separados y cada jugador debe colocar a su H&eacute;roe en una Zona de Partida distinta. En una partida con 5 o 6 H&eacute;roes, 1 o 2 Zonas de Partida pueden contener un m&aacute;ximo de 2 H&eacute;roes. A todos los efectos (salvo para el Monstruo Errante Final), trata la Misi&oacute;n como si solo estuvieran jugando 2 H&eacute;roes.<p>En una partida con menos de 4 H&eacute;roes, retira suficientes Losetas para que solo queden la Loseta del Jefe ({tileLabel.center}) m&aacute;s 1 Loseta por H&eacute;roe. No retires la Loseta {tileLabel.first}.</p>"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Las Cuadrillas se generan solo con 2 Secuaces y su L&iacute;der, y los Monstruos Errantes tienen la Vida equivalente a solo 2 H&eacute;roes."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Las Losetas no est&aacute;n conectadas en esta Misi&oacute;n y solo se puede acceder a ellas usando {label.gate@2} {label.gate@1}, representados por los marcadores de Objetivo, que sin embargo est&aacute;n desactivados." + "<p>{label.gate:capital@3} {label.gate@0} se activa inmediatamente y su marcador de Objetivo se voltea a su lado de color cuando su Loseta correspondiente se queda sin Enemigos y se han revelado todas sus C&aacute;maras.</p>" + "Cualquier H&eacute;roe que haya activado {label.gate@4} puede gastar 1 PM mientras se encuentre en una Zona con un marcador de Objetivo de cualquier color para moverse hasta cualquier otra zona con un marcador de Objetivo de cualquier color."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Cuando abras la puerta con el contorno rojo de la Loseta {tileLabel.center}, no resuelvas cartas de Puerta; retira el marcador de Corrupci&oacute;n {symbol.corruptionToken} y genera un Monstruo Errante de nivel 5 en su zona.<p>Roba cartas del mazo de Objetos de Horda de nivel 5 hasta revelar un arma con el mismo tipo de ataque que el Monstruo Errante. Equipa esa arma al Monstruo Errante, a&ntilde;adiendo los dados del arma a su reserva de dados de Ataque.</p><p>Cuando se derrote al Monstruo Errante, {label.questVictory@0}.</p>"
                                                    }
                                                ],
                                                campaignExplanation:[
                                                    {
                                        ...
                                        rules:[
                                            {
                                                ...
                                                summary:{
                                                    ...
                                                    ES:"Terminar el combate pendiente contra {boss.bossBadName@0}"
                                                }
                                            }
                                        ],
                                        levelByTilesCount:{
                        ...
                        },
                        {
                            ...
                            objective:{
                                ...
                                ES:"Recoge recursos de marcadores del mapa o una cantidad fija seg&uacute;n el tipo de enemigo eliminado. Alcanza una cuota de recursos y realiza una acci&oacute;n en una zona para ganar."
                            },
                            by:{
                                IT:"Ispirato all'avventura di Hellscape \"Il Collezionista di Anime\"",
                                EN:"Inspired by the Hellscape quest \"The Soul Collector\"",
                                ES:"Inspirado en la misi&oacute;n de Hellscape \"El Coleccionista de Almas\"",
                            },
                                                ...
                                                gate:[
                                                    {
                                                        ...
                                                        ES:[ "las", "Puertas", "que conducen", "est&aacute;n cerradas con barrotes por", "la", "Puerta", "Zona de la Puerta" ]
                                                    },{
                                                        ...
                                                        ES:[ "los", "Portales", "que conducen", "son mantenidos firmemente cerrados por", "el", "Portal", "Zona del Portal" ]
                                                    },{
                                                        ...
                                                        ES:[ "el", "puente", "que nos permitir&iacute;a continuar", "est&aacute; bloqueado por", "el", "puente", "Zona del Puente" ]
                                                    }
                                                ],
                                                destination:[
                                                    {
                                                ...
                                                block:[
                                                    {
                                                        ...
                                                        ES:[ "una Interdicci&oacute;n Demon&iacute;aca", "debe desactivarse con una ofrenda de Almas...", "Pero recoger algo tan ef&iacute;mero como un alma puede ser complicado...", "recoger", "las", "almas", "alma", "las", "Prisiones de las Almas", "de", "de", "la Interdicci&oacute;n", "de la", "destrucci&oacute;n", "destruido", "destruirlo", "destruidas", "a destruir", "destruyendo", "todas las" ]
                                                    },{
                                                        ...
                                                        ES:[ "un Gran Guardi&aacute;n", "debe ser convencido de nuestro hero&iacute;smo...", "Pero demostrarlo podr&iacute;a ser muy peligroso...", "recoger", "los", "trofeos", "trofeo", "los", "Iconos del Mal", "de", "de", "el Custodio", "de la", "destrucci&oacute;n", "destruido", "destruirlo", "destruidos", "a destruir", "destruyendo", "todos los" ]
                                                    },{
                                                        ...
                                                        ES:[ "una Guardia Corrupta", "debe ser convencida de colaborar con un buen saco de monedas...", "Pero encontrar oro por esta zona puede costarnos la vida...", "recoger", "las", "monedas", "moneda", "los", "Cofres", "de", "de", "la Guardia", "de la", "apertura", "abierto", "abrirlo", "abiertos", "a abrir", "abriendo", "todos los" ]
                                                    }
                                                ],
                                                toGoOn:[
                                                    {
                                                ...
                                                collectMoreItems:[
                                                    {
                                                        ...
                                                        ES:[ 15, "{label.block:capital@5}", "{label.block:capital@5} por cada H&eacute;roe" ]
                                                    }
                                                ],
                                                collectAllItems:[
                                                    {
                                                        ...
                                                        ES:[ "{label.block@17} {label.block@19} {label.block@8}", "{label.block@18} {label.block@19} {label.block@8}", "{label.block@18} {label.block@19} {label.block@8}" ],
                                                    }
                                                ]
                                            }
                                        ]
                                    ...
                                    title:[
                                        {
                                            ...
                                            ES:"El Coleccionista {label.block@10} {label.block:capital@5}"
                                        },{
                                            EN:"{label.block:capital@4} {label.block:capital@5}",
                                            ES:"{label.block:capital@4} {label.block:capital@5}"
                                        },{
                                            EN:"{label.block:capital@7} {label.block:capital@8}",
                                            ES:"{label.block:capital@7} {label.block:capital@8}"
                                        }
                                    ],
                                    story:[
                                        {
                                            ...
                                            ES:"{label.gate:capital@0} {label.gate@1} {label.gate@2} {label.destination@0} {label.destination@1} {label.gate@3} {label.block@0}. {label.toGoOn@0} {label.block@11} {label.block@1} {label.block@2}"
                                        }
                                    ],
                                    objectivesHeader:[
                                        {
                                                ...
                                                name:[
                                                    {
                                                        ...
                                                        ES:"{label.block:capital@3} {label.block@4} {label.block:capital@5}"
                                                    }
                                                ],
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Recoger 10 {label.block:capital@5} por cada H&eacute;roe"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                name:[
                                                    {
                                                        ...
                                                        ES:"{label.destination:capital@2} {label.destination@1}"
                                                    }
                                                ],
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Los H&eacute;roes deben salir de la Mazmorra a trav&eacute;s de {label.gate@4} {label.gate:capital@5}"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"{label.block:capital@4} {label.block:capital@5} provienen de matar Enemigos y de {label.block@12} {label.block@13} de los marcadores de Objetivo. Los H&eacute;roes recogen 1 {label.block:capital@6} por cada Secuaz o L&iacute;der matado por un H&eacute;roe. Cada Monstruo Errante concede a los H&eacute;roes 3 {label.block:capital@5} al morir. Los marcadores de Objetivo representan {label.block@7} {label.block@8} y conceden 5 {label.block:capital@5} cuando {label.block@16}. Coloca marcadores de Salud en la {label.gate@6} (indicada por el marcador de Objetivo gris) para llevar la cuenta {label.block@9} {label.block:capital@5} que hayas recogido."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Los marcadores de Objetivo con el lado de color hacia arriba representan {label.block@7} {label.block@8}. Cualquier H&eacute;roe que se encuentre en la misma Zona que un marcador de Objetivo puede gastar 1 acci&oacute;n para {label.block@15}. Retira el marcador de la Mazmorra. El H&eacute;roe que lo ha {label.block@14} obtiene 5 PE y los H&eacute;roes recogen 5 {label.block:capital@5}."
                                                    }
                                                ],
                                                campaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"Los marcadores de Objetivo con el lado de color hacia arriba representan {label.block@7} {label.block@8}. Cualquier H&eacute;roe que se encuentre en la misma Zona que un marcador de Objetivo puede gastar 1 acci&oacute;n para {label.block@15}. Retira el marcador de la Mazmorra. Los H&eacute;roes recogen 5 {label.block:capital@5} y todos los H&eacute;roes ganan 5 PE."
                                                    }
                                                ],
                                                miniCampaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"Los marcadores de Objetivo con el lado de color hacia arriba representan {label.block@7} {label.block@8}. Cualquier H&eacute;roe que se encuentre en la misma Zona que un marcador de Objetivo puede gastar 1 acci&oacute;n para {label.block@15}. Retira el marcador de la Mazmorra. Los H&eacute;roes recogen 5 {label.block:capital@5} y todos los H&eacute;roes ganan {label.miniCampaignObjectivesXp:split:tokensCount.objective::5} PE."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"En cuanto los H&eacute;roes tengan un total de 10 {label.block:capital@5} por H&eacute;roe, podr&aacute;n salir de la Mazmorra a trav&eacute;s de {label.gate@4} {label.gate:capital@5}: un H&eacute;roe que se encuentre en la {label.gate@6} puede gastar 1 PM para salir de la Mazmorra. En cuanto todos los H&eacute;roes hayan salido de la Mazmorra, {label.questVictory@0}."
                                                    }
                                                ]
                                            }
                                        ]
                                        ...
                                        rules:[
                                            {
                                                ...
                                                summary:{
                                                    ...
                                                    ES:"Elimina a {boss.bossBadName@0}, que espera a los H&eacute;roes {label.destination@3} {label.destination@1}",
                                                }
                                            }
                                        ],
                                        levelByTilesCount:{
                        ...
                        },
                        {
                            ...
                            objective:{
                                ...
                                ES:"Recoge todos los marcadores y realiza una acci&oacute;n en una zona para ganar."
                            },
                            by:{
                                IT:"Ispirato all'avventura di Hellscape \"La Via per Hellscape\"",
                                EN:"Inspired by the Hellscape quest \"Highway to Hellscape\"",
                                ES:"Inspirado en la misi&oacute;n de Hellscape \"La V&iacute;a hacia Hellscape\""
                            },
                                        ...
                                        [
                                            {
                                                reason:[
                                                    { 
                                                        ...
                                                        ES:"La proliferaci&oacute;n de portales alrededor de la capital hace pensar"
                                                    },{
                                                        ...
                                                        ES:"Los misteriosos secuestros ocurridos en las aldeas cercanas sugieren"
                                                    },{
                                                        ...
                                                        ES:"Los incendios que estallaron misteriosamente en los bosques sugieren"
                                                    }
                                                ],
                                                event:[
                                                    {
                                                        ...
                                                        ES:"que se ha cometido alg&uacute;n sacrificio horrendo"
                                                    },{
                                                        IT:"si stia diffondendo un traffico illegale",
                                                        EN:"illegal trafficking is spreading",
                                                        ES:"que se est&aacute; extendiendo un tr&aacute;fico ilegal"
                                                    },{
                                                        IT:"ci sia sotto qualcosa di losco",
                                                        EN:"there's something fishy going on",
                                                        ES:"que hay algo turbio detr&aacute;s de todo esto"
                                                    }
                                                ],
                                                planb:[
                                                    {
                                                        ...
                                                        ES:"No podemos hacer nada al respecto, pero quiz&aacute; podr&iacute;amos sacar partido de la situaci&oacute;n."
                                                    },{
                                                        ...
                                                        ES:"Nadie est&aacute; dispuesto a arriesgarse para poner fin al asunto. Excepto nosotros."
                                                    },{
                                                        IT:"Bisogna fare qualcosa. E in fretta.",
                                                        EN:"Something must be done. And quickly.",
                                                        ES:"Hay que hacer algo. Y r&aacute;pido."
                                                    }
                                                ],
                                                solution:[
                                                    {
                                                        ...
                                                        ES:[ "hay algo que podr&iacute;a conducirnos al Reino Oscuro", "Esta vez podr&iacute;amos llevar la batalla a casa del enemigo", "Entrar en el Reino Oscuro", "Oscuridad Revelada", "Cruzar" ]
                                                    },{
                                                        IT:[
                                                        ...
                                                        ES:[ "hay algo que podr&iacute;a conducirnos al Reino Infernal", "Por fin podr&iacute;amos detener a los responsables de una vez por todas", "Entrar en el Escondite", "Escondite Revelado", "Entrar a trav&eacute;s de" ]
                                                    },{
                                                        IT:[
                                                        ...
                                                        ES:[ "podr&iacute;amos descubrir la verdad", "Podr&iacute;amos desvelar el misterio", "Descubrir la Verdad", "Verdad Revelada", "Analizar" ]
                                                    }
                                                ],
                                                block:[
                                                    {
                                                ...
                                                unblock:[
                                                    {
                                                        ...
                                                        ES:[ "interruptor", "interruptores", "los interruptores est&aacute;n representados", "activar", "activar al menos", "a activar todos los", "activando" ],
                                                    },{
                                                        ...
                                                        ES:[ "vela", "velas", "las velas est&aacute;n representadas", "encender", "encender al menos", "a encender todas las", "encendiendo" ],
                                                    },{
                                                        ...
                                                        ES:[ "palanca", "palancas", "las palancas est&aacute;n representadas", "tirar de", "tirar de al menos", "a tirar de todas las", "tirando de" ]
                                                    }
                                                ],
                                                escapeTo:[
                                                    {
                                                ...
                                                actionSameTime:[
                                                    {
                                                        ...
                                                        ES:[ "{label.unblock:capital@4} 2 {label.unblock@1}" ]
                                                    }
                                                ],
                                                collectOptionalItems:[
                                                    {
                                                        ...
                                                        ES:[ "{label.unblock@5} {label.unblock@1}", "{label.unblock@6} {label.collectOptionalItems@3} {label.unblock@1}", "{tokensCount.objective}" ]
                                                    }
                                                ]
                                            }
                                        ]
                                    ...
                                    story:[
                                        {
                                            ...
                                            ES:"{label.reason} que {label.event}. {label.planb} {label.somewhere@0} {label.solution@0}. {label.solution@1}, {label.crazy@0}"
                                        }
                                    ],
                                    objectivesHeader:[
                                        {
                                                ...
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"{label.unblock:capital@3} {label.collectOptionalItems@2} {label.unblock@1}"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"{label.solution@4} {label.escapeTo@0}"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"{label.block:capital} (la puerta con el contorno rojo) permite el paso de los Enemigos: los Enemigos pueden moverse libremente a trav&eacute;s de esta puerta. Para abrir {label.block}, los H&eacute;roes deben {label.unblock@3} {label.collectOptionalItems@2} {label.unblock@1}. {label.block:capital} bloquea la L&iacute;nea de Visi&oacute;n.",
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"{label.unblock:capital@2} mediante marcadores de Objetivo con el lado de color hacia arriba. Cualquier H&eacute;roe que se encuentre en una Zona con uno de estos marcadores de Objetivo puede gastar 1 PM para interactuar con el marcador de Objetivo y retirarlo de la Mazmorra. El H&eacute;roe que lo hace obtiene 3 PE."
                                                    }
                                                ],
                                                campaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"{label.unblock:capital@2} mediante marcadores de Objetivo con el lado de color hacia arriba. Cualquier H&eacute;roe que se encuentre en una Zona con uno de estos marcadores de Objetivo puede gastar 1 PM para interactuar con el marcador de Objetivo y retirarlo de la Mazmorra."
                                                    }
                                                ],
                                                miniCampaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"{label.unblock:capital@2} mediante marcadores de Objetivo con el lado de color hacia arriba. Cualquier H&eacute;roe que se encuentre en una Zona con uno de estos marcadores de Objetivo puede gastar 1 PM para interactuar con el marcador de Objetivo, retirarlo de la Mazmorra, y todos los H&eacute;roes ganan {label.miniCampaignObjectivesXp:split:tokensCount.objective} PE"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"En cuanto se retiren {label.collectOptionalItems@2} marcadores de Objetivo con el lado de color hacia arriba, {label.block} se abre. Da la vuelta al marcador de Puerta resaltado con el contorno rojo a su lado abierto y revela la C&aacute;mara con normalidad."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Cualquier H&eacute;roe en la Zona marcada con el marcador de Objetivo gris puede gastar 1 PM para salir de la Mazmorra. Una vez que todos los H&eacute;roes hayan salido, {label.questVictory@0}."
                                                    }
                                                ]
                                            }
                                        ]
                                        ...
                                        rules:[
                                            {
                                                ...
                                                summary:{
                                                    ...
                                                    ES:"Eliminar a Aquel Que Espera M&aacute;s All&aacute; de {label.escapeTo@1}",
                                                }
                                            }
                                        ],
                                        levelByTilesCount:{
                        ...
                        },
                        {
                            ...
                            objective:{
                                ...
                                ES:"Usa un objeto para hacer vulnerable a un Monstruo Errante y elim&iacute;nalo para ganar."
                            },
                            by:{
                                IT:"Ispirato all'avventura di Hellscape \"La Bestia dell'Orrore\"",
                                EN:"Inspired by the Hellscape quest \"The Horror Beast\"",
                                ES:"Inspirado en la misi&oacute;n de Hellscape \"La Bestia del Horror\""
                            },
                            suggestedTilesCount:4,
                            versions:[
                                {
                                                ...
                                                incipit:[
                                                    {
                                                        ...
                                                        ES:[ "Seg&uacute;n muchas leyendas," ]
                                                    },{
                                                ...
                                                enemy:[
                                                    {
                                                        ...
                                                        ES:[ "una", "Bestia Arcana", "la", "Bestia", "de la", "sobre la", "a la", "matarla", "matarla", "eliminada" ]
                                                    },{
                                                        ...
                                                        ES:[ "una", "Criatura Corrupta", "la", "Criatura", "de la", "sobre la", "a la", "matarla", "matarla", "eliminada" ]
                                                    },{
                                                        ...
                                                        ES:[ "un", "Ser Perdido", "el", "Ser", "del", "sobre el", "al", "matarlo", "matarlo", "eliminado" ]
                                                    }
                                                ],
                                                doing:[
                                                    {
                                                ...
                                                fear:[
                                                    {
                                                        ...
                                                        ES:[ "se mantiene alejada de algunas zonas de su territorio" ]
                                                    },{
                                                        IT:[ "sembra fugga da alcune aree" ],
                                                        EN:[ "seemed to escape from some areas" ],
                                                        ES:[ "parec&iacute;a huir de algunas zonas" ]
                                                    },{
                                                        IT:[ "sta evitando alcune zone specifiche" ],
                                                        EN:[ "avoids some specific areas" ],
                                                        ES:[ "est&aacute; evitando algunas zonas concretas" ]
                                                    },
                                                ],
                                                investigate:[
                                                    {
                                                        ...
                                                        ES:[ "Al investigar, descubrimos que esas zonas est&aacute;n sembradas de" ]
                                                    },{
                                                        IT:[ "In queste aree, alcune pattuglie hanno trovato mucchi di" ],
                                                        EN:[ "There, some patrols found piles of" ],
                                                        ES:[ "All&iacute;, algunas patrullas encontraron montones de" ]
                                                    },{
                                                        ...
                                                        ES:[ "Esas zonas son conocidas por tener una gran concentraci&oacute;n de" ]
                                                    }
                                                ],
                                                but:[
                                                    {
                                                        ...
                                                        ES:[ "Aunque no tenemos tiempo para resolver el enigma de su presencia" ]
                                                    },{
                                                        ...
                                                        ES:[ "Los Sabios est&aacute;n investigando el asunto, pero no tenemos tiempo que perder" ]
                                                    },{
                                                        IT:[ "Non abbiamo abbastanza tempo per scoprire il motivo" ],
                                                        EN:[ "We don't have enough time to find out why" ],
                                                        ES:[ "No tenemos tiempo suficiente para descubrir el motivo" ]
                                                    }
                                                ],
                                                item:[
                                                    {
                                                        ...
                                                        ES:[ "Pluma Angelical", "Plumas Angelicales", "las", "una", "quiz&aacute; podamos usar estos restos para debilitar a la horrenda criatura" ]
                                                    },{
                                                        ...
                                                        ES:[ "Escama Drac&oacute;nica", "Escamas Drac&oacute;nicas", "las", "una", "quiz&aacute; podamos usarlas a nuestro favor" ]
                                                    },{
                                                        ...
                                                        ES:[ "Piedra de Ceniza", "Piedras de Ceniza", "las", "una", "quiz&aacute; podamos prenderles fuego para hacer vulnerable a la criatura" ]
                                                    }
                                                ],
                                                luckily:[
                                                    {
                                                        ...
                                                        ES:[ "Pero no todo est&aacute; perdido:" ]
                                                    },{
                                                        IT:[ "I ranger, per&ograve;, hanno scoperto uno strano comportamento:" ],
                                                        EN:[ "The rangers, however, discovered strange behavior:" ],
                                                        ES:[ "Sin embargo, los guardabosques descubrieron un comportamiento extra&ntilde;o:" ]
                                                    }
                                                ],
                                                bossBeat:BOSSBEAT,
                                                questVictory:QUESTVICTORY,
                                                collectLessItems:[
                                                    {
                                                        ...
                                                        ES:[ "a colocar menos {label.item@1}", "colocando solo {label.collectLessItems@2} {label.item@1}" ],
                                                    }
                                                ]
                                            }
                                        ]
                                    ...
                                    story:[
                                        {
                                            ...
                                            ES:"{label.incipit@0} {label.enemy@0} {label.enemy@1} {label.doing@0} y {label.impossible@0}. {label.luckily@0} {label.enemy@2} {label.enemy@3} {label.fear@0}. {label.investigate@0} {label.item@1}! {label.but@0}, {label.item@4}.",
                                        }
                                    ],
                                    challenges:[
                                        { intensity:1, tag:"default" },
                                                ...
                                                name:[
                                                    {
                                                        ...
                                                        ES:"Derrotar a {label.enemy@2} {label.enemy@3}",
                                                    }
                                                ],
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Usar {label.item@2} {label.item@1} para hacer vulnerable a {label.enemy@2} {label.enemy@3}, y luego {label.enemy@8}."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                name:[
                                                    {
                                                        ...
                                                        ES:"{label.enemy:capital@2} {label.enemy@3}"
                                                    }
                                                ],
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Durante la preparaci&oacute;n, genera un Monstruo Errante aleatorio de nivel 5 en la Zona indicada: se trata {label.enemy@4} {label.enemy@3}. {label.enemy:capital@2} {label.enemy@3} se activa con normalidad durante cada Fase de los Enemigos, pero es invulnerable: no puede ser objetivo de ning&uacute;n ataque, habilidad o capacidad, ni sufrir Heridas."
                                                    }
                                                ],
                                                campaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"Durante la preparaci&oacute;n, genera {label.campaignBoss@0} en la Zona indicada: se trata {label.enemy@4} {label.enemy@3}. {label.enemy:capital@2} {label.enemy@3} se activa con normalidad durante cada Fase de los Enemigos, pero es invulnerable: no puede ser objetivo de ning&uacute;n ataque, habilidad o capacidad, ni sufrir Heridas."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"{label.item:capital@2} {label.item:capital@1} est&aacute;n representadas por marcadores de Objetivo. Cualquier H&eacute;roe que se encuentre en una Zona con un marcador de Objetivo puede gastar 1 PM para interactuar con ese marcador y recogerlo (un H&eacute;roe puede llevar m&aacute;s de 1). Un H&eacute;roe que lleve {label.item@3} {label.item@0} mientras se encuentra en la Zona {label.enemy@4} {label.enemy@3} puede gastar 1 PM para colocar 1 {label.item@0} {label.enemy@5} {label.enemy@3}. {label.enemy:capital@2} {label.enemy@3} es vulnerable mientras tenga {label.item@3} {label.item@0}: los H&eacute;roes pueden atacarla, usar habilidades y capacidades, e infligirle Heridas {label.enemy@6} {label.enemy@3}. Al principio de cada asalto, retira todas {label.item@2} {label.item:capital@1} {label.enemy@5} {label.enemy@3}, que vuelve a ser invulnerable."
                                                    }
                                                ],
                                                miniCampaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"{label.item:capital@2} {label.item:capital@1} est&aacute;n representadas por marcadores de Objetivo. Cualquier H&eacute;roe que se encuentre en una Zona con un marcador de Objetivo puede gastar 1 PM para interactuar con ese marcador, recogerlo (un H&eacute;roe puede llevar m&aacute;s de 1), y todos los H&eacute;roes ganan {label.miniCampaignObjectivesXp:split:tokensCount.objective} PE. Un H&eacute;roe que lleve {label.item@3} {label.item@0} mientras se encuentra en la Zona {label.enemy@4} {label.enemy@3} puede gastar 1 PM para colocar 1 {label.item@0} {label.enemy@5} {label.enemy@3}. {label.enemy:capital@2} {label.enemy@3} es vulnerable mientras tenga {label.item@3} {label.item@0}: los H&eacute;roes pueden atacarla, usar habilidades y capacidades, e infligirle Heridas {label.enemy@6} {label.enemy@3}. Al principio de cada asalto, retira todas {label.item@2} {label.item:capital@1} {label.enemy@5} {label.enemy@3}, que vuelve a ser invulnerable."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"En cuanto {label.enemy@2} {label.enemy@3} sea {label.enemy@9}, {label.questVictory@0}."
                                                    }
                                                ]
                                            }
                                        ]
                                        ...
                                        rules:[
                                            {
                                                ...
                                                summary:{
                                                    ...
                                                    ES:"Elimina a {boss.bossBadName@0}, instigador {label.enemy@4} {label.enemy@3}",
                                                }
                                            }
                                        ],
                                        preparation:{
                        ...
                        },
                        {
                            ...
                            objective:{
                                ...
                                ES:"Elimina a todos los Monstruos Errantes especiales para ganar."
                            },
                            by:{
                                IT:"Ispirato all'avventura di Hellscape \"Il Labirinto Infernale\"",
                                EN:"Inspired by the Hellscape quest \"Hellish Maze\"",
                                ES:"Inspirado en la misi&oacute;n de Hellscape \"Laberinto Infernal\""
                            },
                            suggestedTilesCount:4,
                            versions:[
                                {
                                                ...
                                                incipit:[
                                                    {
                                                        ...
                                                        ES:[ "En los textos sagrados se dice que" ]
                                                    }
                                                ],
                                                monsters:[
                                                    {
                                                ...
                                                objective:[
                                                    {
                                                        ...
                                                        ES:[ "Se dice que quien logre derrotarlas a todas" ]
                                                    },{
                                                        ...
                                                        ES:[ "Nadie ha logrado jam&aacute;s derrotarlas a todas, pero en los textos antiguos se cuenta que quien logre derrotarlas a todas" ]
                                                    },{
                                                        IT:[ "Chi riuscir&agrave; a porre fine alla loro tormento" ],
                                                        EN:[ "Those who will be able to put an end to their torment" ],
                                                        ES:[ "Quien logre poner fin a su tormento" ]
                                                    }
                                                ],
                                                prize:[
                                                    {
                                                ...
                                                maze:[
                                                    {
                                                        ...
                                                        ES:[ "El Laberinto", "los pasadizos m&aacute;gicos", "El Laberinto Encantado", "Magia" ]
                                                    },{
                                                        ...
                                                        ES:[ "Las Mazmorras", "los teletransportadores", "Las Mazmorras Desconectadas", "Teletransportes" ]
                                                    },{
                                                        IT:[ "I Piani", "le scale", "Il Palazzo", "Scale" ],
                                                        EN:[ "The Floors", "the stairs", "The Palace", "Stairs" ],
                                                        ES:[ "Los Pisos", "las escaleras", "El Palacio", "Escaleras" ]
                                                    }
                                                ],
                                                bossBeat:BOSSBEAT,
                                                questVictory:QUESTVICTORY,
                                                eliminateEnemy:[
                                                    {
                                                        ...
                                                        ES:[ "2 o m&aacute;s {label.monsters@1}" ]
                                                    }
                                                ]
                                            }
                                        ]
                                    ...
                                    title:[
                                        {
                                            ...
                                            ES:"{label.monsters:capital@0} {label.monsters:capital@1}"
                                        },{
                                            EN: "{label.roamingPlace:capital@0} {label.roamingPlace:capital@1}",
                                            ES:"{label.roamingPlace:capital@0} {label.roamingPlace:capital@1}"
                                        }
                                    ],
                                    story:[
                                        {
                                            ...
                                            ES:"{label.incipit@0} {label.monsters@3} {tokensCount.corruption} {label.monsters@1} {label.roamingWay@0} {label.roamingPlace@0} {label.roamingPlace@1}. {label.objective@0} {label.prize@0}. {label.mystery@0}"
                                        }
                                    ],
                                    challenges:[
                                        { intensity:1, tag:"default" },
                                                ...
                                                name:[
                                                    {
                                                        ...
                                                        ES:"Matar a {label.monsters@0} {label.monsters@1}"
                                                    }
                                                ],
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Matar a los {tokensCount.corruption} Monstruos Errantes Especiales"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Cada vez que se revele una de las C&aacute;maras con un marcador de Corrupci&oacute;n {symbol.corruptionToken}, adem&aacute;s de los pasos habituales para revelar una C&aacute;mara, genera tambi&eacute;n un Monstruo Errante en la Zona indicada por el marcador de Corrupci&oacute;n de esa C&aacute;mara. Ese Monstruo Errante es 1 {label.monsters@2} {label.monsters@1}. En cuanto los {tokensCount.corruption} {label.monsters@0} {label.monsters@1} hayan sido eliminados, {label.questVictory@0}."
                                                    }
                                                ],
                                                miniCampaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"Cada vez que se revele una de las C&aacute;maras con un marcador de Corrupci&oacute;n {symbol.corruptionToken}, adem&aacute;s de los pasos habituales para revelar una C&aacute;mara, genera tambi&eacute;n un Monstruo Errante en la Zona indicada por el marcador de Corrupci&oacute;n de esa C&aacute;mara. Ese Monstruo Errante es 1 {label.monsters@2} {label.monsters@1} y, cuando es derrotado, todos los H&eacute;roes ganan {label.miniCampaignObjectivesXp:split:tokensCount.corruption} PE. En cuanto los {tokensCount.corruption} {label.monsters@0} {label.monsters@1} hayan sido eliminados, {label.questVictory@0}."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Las Losetas no est&aacute;n conectadas en esta Misi&oacute;n y solo se puede acceder a ellas usando {label.maze@1}, representados por los marcadores de Objetivo. Cualquier H&eacute;roe puede gastar 1 PM mientras se encuentre en una Zona con un marcador de Objetivo para moverse hasta cualquier otra zona con un marcador de Objetivo.",
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Las Cuadrillas y los Monstruos Errantes tambi&eacute;n pueden usar {label.maze@1}. Durante la Fase de los Enemigos, si no hay H&eacute;roes en una Loseta, cualquier Cuadrilla o Monstruo Errante de esa Loseta se mueve hacia la Zona m&aacute;s cercana con un marcador de Objetivo. Todas las Zonas con marcadores de Objetivo se consideran adyacentes entre s&iacute; para las Cuadrillas y los Monstruos Errantes (pero no permiten L&iacute;nea de Visi&oacute;n entre ellas).",
                                                    }
                                                ]
                                            }
                                        ]
                                        ...
                                        rules:[
                                            {
                                                ...
                                                summary:{
                                                    ...
                                                    ES:"Elimina a {boss.bossBadName@0}, Se&ntilde;or {label.monsters@4} {tokensCount.corruption} {label.monsters@1}",
                                                }
                                            }
                                        ],
                                        levelByTilesCount:{
                        ...
                        },
                        {
                            ...
                            objective:{
                                ...
                                ES:"Usa un arma maldita para romper algunos elementos para ganar."
                            },
                            by:{
                                IT:"Ispirato all'avventura di Hellscape \"La Spada Maledetta\"",
                                EN:"Inspired by the Hellscape quest \"The Cursed Sword\"",
                                ES:"Inspirado en la misi&oacute;n de Hellscape \"La Espada Maldita\""
                            },
                            suggestedTilesCount:4,
                            versions:[
                                {
                                                ...
                                                weapon:[
                                                    {
                                                        ...
                                                        ES:[ "la Espada Maldita", "la Espada Maldita", "en el mazo de Tesoro Com&uacute;n", "el Espad&oacute;n Enorme y Temible", "la Espada", "Arma Maldita", "se la queda para &eacute;l" ]
                                                    }
                                                ],
                                                toBreak:[
                                                    {
                                                        ...
                                                        ES:[ "los", "Cristales del Vac&iacute;o", "un", "Cristal del Vac&iacute;o", "afectarlos", "retir&aacute;ndolo", "da&ntilde;arlos" ]
                                                    },{
                                                        ...
                                                        ES:[ "los", "Monolitos del Odio", "un", "Monolito del Odio", "afectarlos", "retir&aacute;ndolo", "da&ntilde;arlos" ]
                                                    },{
                                                        ...
                                                        ES:[ "las", "Estatuas de la Muerte", "una", "Estatua de la Muerte", "afectarlas", "retir&aacute;ndola", "da&ntilde;arlas" ]
                                                    }
                                                ],
                                                purpose:[
                                                    {
                                                        ...
                                                        ES:[ "debilitaremos el v&iacute;nculo entre el Reino Oscuro y nuestro mundo" ]
                                                    },{
                                                        IT:[ "impediremo al Grande Antico di tornare sulla Terra" ],
                                                        EN:[ "we will prevent the Great Old One from returning to Earth" ],
                                                        ES:[ "impediremos que el Gran Antiguo regrese a la Tierra" ]
                                                    },{
                                                        ...
                                                        ES:[ "pondremos fin a la plaga que tiene de rodillas al reino desde hace demasiado tiempo" ]
                                                    }
                                                ],
                                                but:[
                                                    {
                                                        ...
                                                        ES:[ "Pero solo hay un artefacto capaz al menos de {label.toBreak@4}, y est&aacute; maldito" ]
                                                    },{
                                                        ...
                                                        ES:[ "Pero la &uacute;nica forma de {label.toBreak@6} es empu&ntilde;ando un {label.weapon@5}" ]
                                                    },{
                                                        ...
                                                        ES:[ "Por desgracia, el &uacute;nico artefacto capaz de ayudarnos tambi&eacute;n podr&iacute;a matarnos a todos" ]
                                                    }
                                                ],
                                                consequence:[
                                                    {
                                                        ...
                                                        ES:[ "&iexcl;quien la empu&ntilde;e demasiado tiempo sucumbir&aacute;!", "toda la fuerza del H&eacute;roe se drenar&aacute;" ]
                                                    },{
                                                        ...
                                                        ES:[ "&iexcl;quien la use demasiado tiempo perder&aacute; su alma!", "el arma reclamar&aacute; el alma del H&eacute;roe" ]
                                                    },{
                                                        ...
                                                        ES:[ "&iexcl;de quien la haya empu&ntilde;ado demasiado tiempo se dice que solo queda un mont&oacute;n de cenizas!", "el cuerpo del H&eacute;roe quedar&aacute; reducido a polvo" ]
                                                    }
                                                ],
                                                bossBeat:BOSSBEAT,
                                                questVictory:QUESTVICTORY,
                                                keepItem:[
                                                    {
                                                        ...
                                                        ES:[ "{label.weapon@0} {label.weapon@6}", "{label.weapon@0}" ]
                                                    }
                                                ]
                                            }
                                        ]
                                    ...
                                    title:[
                                        {
                                            ...
                                            ES:"{label.toBreak@0} {label.toBreak@1}"
                                        }
                                    ],
                                    story:[
                                        {
                                            ...
                                            ES:"Destruir {label.toBreak@0} {label.toBreak@1} {label.purpose@0}. {label.but@0}: {label.consequence@0}"
                                        }
                                    ],
                                    objectivesHeader:[
                                        {
                                                ...
                                                name:[
                                                    {
                                                        ...
                                                        ES:"Destruir {label.toBreak@0} {label.toBreak@1}"
                                                    }
                                                ],
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Usar {label.weapon@0} para destruir {label.toBreak@0} {tokensCount.objective} {label.toBreak@1}"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"No permitas que {label.weapon@1} derrote a ning&uacute;n H&eacute;roe"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Durante la preparaci&oacute;n, busca {label.weapon@2} {label.weapon@3} y elige a un H&eacute;roe para que lleve ese objeto como su arma inicial en lugar de un arma normal: esta es {label.weapon@0}."
                                                    }
                                                ],
                                                campaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"Durante la preparaci&oacute;n, roba la carta Campa&ntilde;a 20 de Heavenfall y elige a un H&eacute;roe para que lleve ese objeto como arma: esta es {label.weapon@0}."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Un H&eacute;roe que empu&ntilde;e {label.weapon@0} sufre, al principio de cada Fase de los H&eacute;roes, una cantidad de Heridas que depende de cu&aacute;nto tiempo lleve empu&ntilde;ando {label.weapon@4}.<p>Estas Heridas se aplican antes de que surta efecto cualquier marcador de Portador de Vida:</p><ul>" + "<li><b>1.&ordf; ronda</b>: 1 Herida</li>" + "<li><b>2.&ordf; ronda consecutiva</b>: 2 Heridas</li>" + "<li><b>3.&ordf; ronda consecutiva</b>: 3 Heridas</li>" + "<li><b>4.&ordf; ronda consecutiva</b>: &iexcl;Derrota! Si un H&eacute;roe empieza su 4.&ordf; ronda consecutiva empu&ntilde;ando {label.weapon@0}, {label.consequence@1} y la Misi&oacute;n termina en derrota.</li>" + "</ul><p>Usa marcadores de Corrupci&oacute;n {symbol.corruptionToken} para llevar la cuenta del n&uacute;mero de rondas que un mismo H&eacute;roe lleva empu&ntilde;ando {label.weapon@0}. En cuanto un H&eacute;roe pase {label.weapon@0} a otro H&eacute;roe mediante una acci&oacute;n de Intercambiar, descarta los marcadores y vuelve a empezar la cuenta. {label.weapon:capital@0} no puede guardarse en el Inventario de un H&eacute;roe.</p>"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"{label.toBreak:capital@0} {label.toBreak@1} est&aacute;n representados por marcadores de Objetivo. Un H&eacute;roe que tenga equipada {label.weapon@0} y se encuentre en la misma Zona que un marcador de Objetivo puede gastar 1 acci&oacute;n para destruir {label.toBreak@2} {label.toBreak@3}, {label.toBreak@5} de la Mazmorra y obteniendo 5 PE. Una vez retirados todos los marcadores, {label.questVictory@0}."
                                                    }
                                                ],
                                                campaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"{label.toBreak:capital@0} {label.toBreak@1} est&aacute;n representados por marcadores de Objetivo. Un H&eacute;roe que tenga equipada {label.weapon@0} y se encuentre en la misma Zona que un marcador de Objetivo puede gastar 1 acci&oacute;n para destruir {label.toBreak@2} {label.toBreak@3}, {label.toBreak@5} de la Mazmorra. Una vez retirados todos los marcadores, {label.questVictory@0}."
                                                    }
                                                ],
                                                miniCampaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"{label.toBreak:capital@0} {label.toBreak@1} est&aacute;n representados por marcadores de Objetivo. Un H&eacute;roe que tenga equipada {label.weapon@0} y se encuentre en la misma Zona que un marcador de Objetivo puede gastar 1 acci&oacute;n para destruir {label.toBreak@2} {label.toBreak@3}, {label.toBreak@5} de la Mazmorra y todos los H&eacute;roes obtienen {label.miniCampaignObjectivesXp:split:tokensCount.objective} PE. Una vez retirados todos los marcadores, {label.questVictory@0}."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                name:[
                                                    {
                                                        ...
                                                        ES:"El Poder de la Destrucci&oacute;n"
                                                    }
                                                ],
                                                explanation:[
                                                    {
                                                        ...
                                                        "</ul>",
                                                        ES:"{label.weapon:capital@0} se hace m&aacute;s fuerte a medida que se destruyen {label.toBreak@0} {label.toBreak@1}. {label.weapon:capital@0} obtiene los siguientes dados de Ataque seg&uacute;n el n&uacute;mero de marcadores de Objetivo que se hayan retirado de la Mazmorra:<ul>" + "<li>1 marcador: +1 {symbol.yellowDie}</li>" + "<li>2 marcadores: +2 {symbol.yellowDie}</li>" + "<li>3 marcadores: +2 {symbol.yellowDie} +1 {symbol.orangeDie}</li>" + "<li>4 marcadores: +2 {symbol.yellowDie} +2 {symbol.orangeDie}</li>" + "</ul>"
                                                    }
                                                ],
                                                campaignExplanation:[]
                                            }
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"El H&eacute;roe no sufre Heridas acumulativas (en su lugar, sufre 1 Herida por ronda). El H&eacute;roe no queda derrotado si empu&ntilde;a {label.weapon@0} durante 4 rondas consecutivas y puede elegir usar cualquier arma inicial como \"{label.weapon@5}\"."
                                                    }
                                                ],
                                                campaignExplanation:[]
                                            }
                                            ...
                                            rewards:[
                                                {
                                                    ...
                                                    ES:"Vuelve a colocar la carta Campa&ntilde;a 20 de Heavenfall con las dem&aacute;s cartas de Misi&oacute;n y roba 1 carta del mazo de Tesoros &Eacute;picos."
                                                }
                                            ],
                                            sideQuests:[
                                                { tags:[
                                    ...
                                    boss:{
                                        preparation:{
                                            ...
                                            ES:"<p>A partir de ahora, {label.weapon@0} se comporta como un arma normal. El H&eacute;roe que la empu&ntilde;a puede retirarla o sustituirla por otra arma de su inventario antes del Combate contra el Jefe.</p>"
                                        },
                                        rules:[
                                            {
                                                type:"objective",
                                                ...
                                                summary:{
                                                    ...
                                                    ES:"Elimina a {boss.bossBadName@0}, creador de {label.weapon@0}",
                                                }
                                            }
                                        ],
                                        levelByTilesCount:{
                        ...
                        },
                        {
                            ...
                            objective:{
                                ...
                                ES:"Escolta a un PNJ hasta una zona para ganar."
                            },
                            by:{
                                IT:"Ispirato all'avventura di Hellscape \"Il Passaggio\"",
                                EN:"Inspired by the Hellscape quest \"The Passage\"",
                                ES:"Inspirado en la misi&oacute;n de Hellscape \"El Pasadizo\""
                            },
                            suggestedTilesCount:3,
                            versions:[
                                {
                                                ...
                                                escorting:[
                                                    {
                                                        ...
                                                        ES:[ "un invocador", "el invocador", "el Invocador", "Estad&iacute;sticas del Invocador", "un sacerdote" ]
                                                    },
                                                    {
                                                        ...
                                                        ES:[ "un encantador", "el encantador", "el Encantador", "Estad&iacute;sticas del Encantador", "un mago" ],
                                                    },
                                                    {
                                                        ...
                                                        ES:[ "un aprendiz de mago", "el aprendiz de mago", "el Aprendiz", "Estad&iacute;sticas del Aprendiz de Mago", "alguien dispuesto a arriesgarse" ]
                                                    }
                                                ],
                                                destination:[
                                                    {
                                                        ...
                                                        ES:[ "el infierno", "al Infierno", "hacia las profundidades" ]
                                                    },
                                                    {
                                                        IT:[ "aldil&egrave;", "nell'Aldil&agrave;", "oltre" ],
                                                        EN:[ "afterlife", "the Afterlife", "beyond life" ],
                                                        ES:[ "el m&aacute;s all&aacute;", "al M&aacute;s All&aacute;", "m&aacute;s all&aacute; de la vida" ]
                                                    },
                                                    {
                                                        IT:[ "segrete", "nelle Segrete", "la sotto" ],
                                                        EN:[ "dungeon", "the Dungeon", "down there" ],
                                                        ES:[ "la mazmorra", "a las Mazmorras", "hasta all&iacute; abajo" ]
                                                    }
                                                ],
                                                door:[
                                                    {
                                                        ...
                                                        ES:[ "a la Grieta", "la Grieta", "Zona de la Grieta", "de la Grieta", "en la Grieta", "canalizar la energ&iacute;a de la Grieta", "usar la energ&iacute;a del portal" ]
                                                    },
                                                    {
                                                        ...
                                                        ES:[ "a la Puerta", "la Puerta", "Zona de la Puerta", "de la Puerta", "en la Puerta", "levantar la maldici&oacute;n de la Puerta", "eliminar su maldici&oacute;n" ]
                                                    },
                                                    {
                                                        ...
                                                        ES:[ "al Pasadizo", "el Pasadizo", "Zona del Pasadizo", "del Pasadizo", "en el Pasadizo", "revelar la posici&oacute;n del Pasadizo", "desvelar su posici&oacute;n exacta" ]
                                                    }
                                                ],
                                                intro1:[
                                                    {
                                                        ...
                                                        ES:[ "Llev&aacute;bamos d&iacute;as buscando informaci&oacute;n sobre c&oacute;mo infiltrarnos {label.destination@1}." ]
                                                    },
                                                    {
                                                        ...
                                                        ES:[ "Sab&iacute;amos d&oacute;nde estaba {label.door@1}, pero no conoc&iacute;amos ninguna forma de {label.door@6}." ]
                                                    },
                                                    {
                                                        ...
                                                        ES:[ "No hab&iacute;a otra manera. Necesit&aacute;bamos la ayuda de {label.escorting@4}..." ]
                                                    }
                                                ],
                                                intro2:[
                                                    {
                                                ...
                                                noDamage:[
                                                    {
                                                        ...
                                                        ES:[ "{label.escorting@2}", "{label.escorting:capital@2}" ]
                                                    }
                                                ]
                                            }
                                        ]
                                    ...
                                    story:[
                                        {
                                            ...
                                            ES:"{label.intro1@0} {label.intro2@0} {label.escorting@0} dispuesto a llevarnos hasta {label.door@0} y {label.door@6} {label.lead@0}. Solo tenemos que mantener con vida {label.escorting@1} durante el camino que nos llevar&aacute; {label.destination@2}...",
                                        }
                                    ],
                                    objectivesHeader:[
                                        {
                                                ...
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Mant&eacute;n con vida {label.escorting@2} hasta que llegue {label.door@1}"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Entrar a trav&eacute;s de {label.door@1}",
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Durante la preparaci&oacute;n, coge una miniatura de H&eacute;roe sin usar que represente {label.escorting@2} y col&oacute;cala en la Zona de Partida de los H&eacute;roes (sin asignarle una base). Si no queda ninguna miniatura de H&eacute;roe disponible, usa en su lugar un marcador de Objetivo gris para representar {label.escorting@2}."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"A partir de la segunda ronda, al principio de cada Fase de los H&eacute;roes, {label.escorting@2} se mueve 2 Zonas hacia la puerta con el borde rojo, siguiendo siempre el camino m&aacute;s corto. {label.escorting:capital@2} no puede abrir Puertas. {label.escorting:capital@2} nunca puede abandonar una Zona que contenga Enemigos. {label.escorting:capital@2} se considera un H&eacute;roe a efectos de determinar si puede ser objetivo de H&eacute;roes y Enemigos, pero no puede realizar ninguna acci&oacute;n salvo moverse del modo descrito arriba. No puede llevar objetos."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"En cuanto {label.escorting:capital@2} alcanza la zona con la puerta de borde rojo, si est&aacute; cerrada, termina su movimiento y abre la puerta. Revela la C&aacute;mara con normalidad. Si la puerta est&aacute; abierta, {label.escorting:capital@2} contin&uacute;a su movimiento hacia {label.door@1}, representado por el marcador de Objetivo."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"En cuanto {label.escorting:capital@2} alcanza la {label.door@2}, {label.door@5}. Da la vuelta al marcador de Objetivo y retira {label.escorting@2} de la Mazmorra. Hecho esto, cualquier H&eacute;roe puede gastar 1 PM en la {label.door@2} para salir de la Mazmorra. En cuanto todos los H&eacute;roes hayan entrado {label.door@4}, {label.questVictory@0}."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Salud 8, Defensa: 2 {symbol.blueDie}"
                                                    }
                                                ]
                                            }
                                        ]
                                        ...
                                        rules:[
                                            {
                                                ...
                                                summary:{
                                                    ...
                                                    ES:"Elimina a {boss.bossBadName@0}, que espera m&aacute;s all&aacute; de {label.door@1}",
                                                }
                                            }
                                        ],
                                        levelByTilesCount:{
                        ...
                        },
                        {
                            ...
                            objective:{
                                ...
                                ES:"Recoge objetos y ll&eacute;valos hasta una zona para ganar."
                            },
                            by:{
                                IT:"Ispirato all'avventura di Hellscape \"L'Artefatto Demoniaco\"",
                                EN:"Inspired by the Hellscape quest \"The Demon Artifact\"",
                                ES:"Inspirado en la misi&oacute;n de Hellscape \"El Artefacto Demon&iacute;aco\""
                            },
                            suggestedTilesCount:4,
                            versions:[
                                {
                                                ...
                                                object:[
                                                    {
                                                        ...
                                                        ES:[ "el artefacto", "los artefactos", "artefactos", "artefacto", "forjar", "de los artefactos" ]
                                                    },{
                                                        ...
                                                        ES:[ "el cristal", "los cristales", "cristales", "cristal", "recomponer", "de los cristales" ]
                                                    },{
                                                        IT: [ "il sigillo", "i sigilli", "sigilli", "sigillo", "comporre", "dei sigilli" ],
                                                        EN: [ "the seal", "the seals", "seals", "seal", "compose", "of the seals" ],
                                                        ES:[ "el sello", "los sellos", "sellos", "sello", "componer", "de los sellos" ]
                                                    }
                                                ],
                                                objectCategory:[
                                                    {
                                                        ...
                                                        ES:"empu&ntilde;a una de estas reliquias"
                                                    },{
                                                        IT: "stringe uno di questi oggetti arcani",
                                                        EN: "hold one of these arcane items",
                                                        ES:"sostiene uno de estos objetos arcanos"
                                                    },{
                                                        IT: "ne possiede uno",
                                                        EN: "own one of them",
                                                        ES:"posee uno de ellos"
                                                    }
                                                ],
                                                realm:[
                                                    {
                                                        ...
                                                        ES:"La Fortaleza Abandonada"
                                                    },{
                                                        IT: "La Torre Demoniaca",
                                                        EN: "The Demon Tower",
                                                        ES:"La Torre Demon&iacute;aca"
                                                    }
                                                ],
                                                place:[
                                                    {
                                                        ...
                                                        ES:"esconde en sus oscuras profundidades {label.amount} {label.object@2}"
                                                    },{
                                                        ...
                                                        ES:"guarda en sus mazmorras abandonadas {label.amount} {label.object@2}"
                                                    },{
                                                        IT: "cela nei suoi meandri {label.amount} {label.object@2}",
                                                        EN: "hides {label.amount} {label.object@2} in its meanders",
                                                        ES:"oculta en sus recovecos {label.amount} {label.object@2}"
                                                    }
                                                ],
                                                amount:[
                                                    {
                                                ...
                                                attribute:[
                                                    {
                                                        ...
                                                        ES:[ "demon&iacute;aco", "demon&iacute;aco" ]
                                                    },{
                                                ...
                                                part:[
                                                    {
                                                        ...
                                                        ES:[ "fragmento", "todos", "los", "fragmentos", "representados", "fragmentos", "Zona del Fragmento" ]
                                                    },{
                                                        ...
                                                        ES:[ "componente", "todos", "los", "componentes", "representados", "componentes", "Zona del Componente" ]
                                                    },{
                                                        IT: [ "parte", "tutte", "le", "parti", "rappresentate", "state raccolte", "Zona della Parte" ],
                                                        EN: [ "part", "", "", "", "", "parts", "Part's Zone"],
                                                        ES:[ "parte", "todas", "las", "partes", "representadas", "partes", "Zona de la Parte" ]
                                                    }
                                                ],
                                                destination:[
                                                    {
                                                        ...
                                                        ES:[ "{label.object@4} {label.object@0} en la Forja Corrupta", "Zona de la Forja Corrupta", "Forjarlo en el Fuego Oscuro" ]
                                                    },{
                                                        ...
                                                        ES:[ "{label.object@4} {label.object@0} en la Fuente Sagrada", "Zona de la Fuente Sagrada", "Reunirlos en la Fuente Sagrada" ]
                                                    },{
                                                        ...
                                                        ES:[ "{label.object@4} {label.object@0} en la Prensa Dorada", "Zona de la Prensa Dorada", "Recomponerlos en la Prensa Dorada" ]
                                                    }
                                                ],
                                                bossBeat:BOSSBEAT,
                                                questVictory:QUESTVICTORY,
                                                collectOptionalItems:[
                                                    {
                                                        ...
                                                        ES:[ "a recoger {label.part@1} {label.part@2} {label.part@5}", "recogiendo {label.collectOptionalItems@3} {label.part@5}", "{tokensCount.objective}" ]
                                                    }
                                                ]
                                            }
                                        ]
                                    ...
                                    story:[
                                        {
                                            ...
                                            ES:"{label.realm} {label.place}. Quien {label.objectCategory} ser&aacute; el poseedor {label.power@0}, &iexcl;pero se arriesga a {label.risk}!",
                                        }
                                    ],
                                    objectivesHeader:[
                                        {
                                                ...
                                                name:[
                                                    {
                                                        ...
                                                        ES:"Recoger {label.part@2} {label.part:capital@3}"
                                                    }
                                                ],
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Recoger {label.collectOptionalItems@2} {label.part:capital@5} de la Mazmorra",
                                                    }
                                                ],
                                                campaignSummary:[
                                                    {
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"{label.part:capital@2} {label.part:capital@3} est&aacute;n {label.part@4} por marcadores de Objetivo con el lado de color hacia arriba. Cualquier H&eacute;roe que se encuentre en la {label.part@6} puede interactuar con &eacute;l para recogerlo e inmediatamente ganar 5 PE."
                                                    }
                                                ],
                                                campaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"{label.part:capital@2} {label.part:capital@3} est&aacute;n {label.part@4} por marcadores de Objetivo con el lado de color hacia arriba. Cualquier H&eacute;roe que se encuentre en la {label.part@6} puede interactuar con &eacute;l para recogerlo."
                                                    }
                                                ],
                                                miniCampaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"{label.part:capital@2} {label.part:capital@3} est&aacute;n {label.part@4} por marcadores de Objetivo con el lado de color hacia arriba. Cualquier H&eacute;roe que se encuentre en la {label.part@6} puede interactuar con &eacute;l para recogerlo, y todos los H&eacute;roes ganan {label.miniCampaignObjectivesXp:split:tokensCount.objective} PE."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Usar {label.collectOptionalItems@2} {label.part:capital@5} para {label.destination@0}",
                                                    }
                                                ],
                                                campaignSummary:[
                                                    {
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Cuando {label.part@1} {label.part@2} {label.part:capital@3} hayan sido {label.part@5}, si todos los H&eacute;roes que posean al menos 1 {label.part:capital@0} se encuentran en la {label.destination@1} (representada por el marcador de Objetivo gris), cualquier H&eacute;roe de esa Zona puede gastar 1 acci&oacute;n para {label.object@4} {label.object@0} y {label.questVictory@1}."
                                                    }
                                                ],
                                                campaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"Cuando {label.collectOptionalItems@2} {label.part:capital@5} hayan sido {label.part@5}, si todos los H&eacute;roes que posean al menos 1 {label.part:capital@0} se encuentran en la {label.destination@1} (representada por el marcador de Objetivo gris), cualquier H&eacute;roe de esa Zona puede gastar 1 acci&oacute;n para {label.object@4} {label.object@0} y {label.questVictory@1}."
                                                    }
                                                ]
                                            }
                                        ]
                                        ...
                                        rules:[
                                            {
                                                ...
                                                summary:{
                                                    ...
                                                    ES:"Elimina a {boss.bossBadName@0}, guardi&aacute;n del poder {label.object@5}",
                                                }
                                            }
                                        ],
                                        preparation:{
                        ...
                        },
                        {
                            ...
                            objective:{
                                ...
                                ES:"Recoge objetos dentro del l&iacute;mite de tiempo y alcanza una zona para ganar."
                            },
                            by:{
                                IT:"Ispirato all'avventura di Hellscape \"Le Chiavi delle Anime\"",
                                EN:"Inspired by the Hellscape quest \"The Soul Keys\"",
                                ES:"Inspirado en la misi&oacute;n de Hellscape \"Las Llaves de las Almas\""
                            },
                            suggestedTilesCount:3,
                            versions:[
                                {
                                                ...
                                                culpritOf:[
                                                    {
                                                        ...
                                                        EN:[ "responsible for" ],
                                                        ES:[ "{label.culprit@1} responsable de" ]
                                                    },{
                                                        IT:[ "{label.culprit@2}origine" ],
                                                        EN:[ "the origin of" ],
                                                        ES:[ "{label.culprit@2} origen de" ]
                                                    },{
                                                        IT:[ "{label.culprit@1} causa" ],
                                                        EN:[ "the cause of" ],
                                                        ES:[ "{label.culprit@1} causa de" ]
                                                    }
                                                ],
                                                event:[
                                                    {
                                                ...
                                                itemOf:[
                                                    {
                                                        ...
                                                        EN:[ "Soul", "of Soul"],
                                                        ES:[ "de las Almas", "del Alma" ]
                                                    },{
                                                        IT:[ "della Luce", "della Luce" ],
                                                        EN:[ "Light", "of Light"],
                                                        ES:[ "de la Luz", "de la Luz" ]
                                                    },{
                                                        IT:[ "delle Ombre", "dell'Ombra" ],
                                                        EN:[ "Shadow", "of Shadow"],
                                                        ES:[ "de las Sombras", "de la Sombra" ]
                                                    }
                                                ],
                                                exit:[
                                                    {
                                                ...
                                                collectTime:[
                                                    {
                                                        ...
                                                        ES:[ "ahorrar algo de tiempo", "recogiendo colectivamente 3 marcadores de Tiempo o m&aacute;s" ]
                                                    }
                                                ]
                                            }
                                        ]
                                    ...
                                    story:[
                                        {
                                            ...
                                            ES:"{label.intro@0} {label.culprit@0} {label.culpritBody@0}, {label.culpritOf@0} {label.event@0}. {label.chance@0} {label.culprit@0}? {label.discover@0}"
                                        }
                                    ],
                                    objectivesHeader:[
                                        {
                                                ...
                                                name:[
                                                    {
                                                        ...
                                                        ES:"Recoger {label.item@0} {label.item@1} {label.itemOf@0}",
                                                    }
                                                ],
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Recoger {label.item@0} {label.item@1} antes de que desaparezcan",
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                summary:[
                                                    {
                                                        ...
                                                        ES:"Salir de la Mazmorra a trav&eacute;s {label.exit@1}"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"La C&aacute;mara {label.exit@1} solo es accesible a trav&eacute;s de la puerta con el borde rojo. Esta puerta est&aacute; cerrada con llave y solo puede abrirse cuando los H&eacute;roes posean colectivamente {label.item@0} {tokensCount.objective} {label.item@1} {label.itemOf@0} para acceder a la C&aacute;mara. Un H&eacute;roe que se encuentre en la zona {label.exit@1} (el marcador de Objetivo gris) puede gastar 1 PM para salir de la Mazmorra. En cuanto todos los H&eacute;roes hayan salido de la Mazmorra, {label.questVictory@0}."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Durante la preparaci&oacute;n, coloca marcadores de Tiempo sobre cada marcador de Objetivo de la misma Zona. Durante cada Fase de la Oscuridad, retira 1 marcador de Tiempo de cada marcador de Objetivo. Si en alg&uacute;n momento los jugadores deben retirar un marcador de un marcador de Objetivo y no queda ninguno, este desaparece y la Misi&oacute;n termina en derrota."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Cada marcador de Objetivo representa {label.item@2} {label.itemOf@0} {label.item@3}. Cualquier H&eacute;roe que se encuentre en la misma Zona que {label.item@2} {label.itemOf@0} {label.item@3} puede gastar 1 acci&oacute;n para recogerla. Cada vez que se recoge {label.item@2} {label.itemOf@0} {label.item@3}, se retiran sus marcadores de Tiempo y cada H&eacute;roe gana 8 PE. Recuerda que {label.item@0} {label.itemOf@0} {label.item@1} est&aacute;n desapareciendo: si {label.item@4} llega a desaparecer, la Misi&oacute;n termina en derrota."
                                                    }
                                                ],
                                                campaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"Cada marcador de Objetivo representa {label.item@2} {label.itemOf@0} {label.item@3}. Cualquier H&eacute;roe que se encuentre en la misma Zona que {label.item@2} {label.itemOf@0} {label.item@3} puede gastar 1 acci&oacute;n para recogerla junto con sus marcadores de Tiempo restantes. Recuerda que {label.item@0} {label.itemOf@0} {label.item@1} est&aacute;n desapareciendo: si {label.item@4} llega a desaparecer, la Misi&oacute;n termina en derrota."
                                                    }
                                                ],
                                                miniCampaignExplanation:[
                                                    {
                                                        ...
                                                        ES:"Cada marcador de Objetivo representa {label.item@2} {label.itemOf@0} {label.item@3}. Cualquier H&eacute;roe que se encuentre en la misma Zona que {label.item@2} {label.itemOf@0} {label.item@3} puede gastar 1 acci&oacute;n para recogerla junto con sus marcadores de Tiempo restantes, y todos los H&eacute;roes ganan {label.miniCampaignObjectivesXp:split:tokensCount.objective} PE. Recuerda que {label.item@0} {label.itemOf@0} {label.item@1} est&aacute;n desapareciendo: si {label.item@4} llega a desaparecer, la Misi&oacute;n termina en derrota."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        ES:"Los enemigos pueden moverse libremente a trav&eacute;s de las puertas, incluso si est&aacute;n cerradas. Las puertas cerradas siguen bloqueando la L&iacute;nea de Visi&oacute;n."
                                                    }
                                                ]
                                            }
                                        ]
                                    ...
                                    boss:{
                                        rules:[
                                            {
                                                ...
                                                summary:{
                                                    ...
                                                    ES:"Eliminar a {boss.bossBadName@0}, {label.culprit@0} {label.culpritBody@0}",
                                                }
                                            }
                                        ],
                                        preparation:{
                                        ...
                                        campaignPreparation:{
                                            ...
                                            ES:"<p>Retira todos los marcadores de Objetivo y de Tiempo del inventario de los H&eacute;roes.</p>"
                                        },
                                        levelByTilesCount:{
                                            3:1,
                                            4:2,
