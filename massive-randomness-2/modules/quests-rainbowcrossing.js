        ...
        BOSSBEAT = [
            {
                ...
                EN:[ "it is eliminated", "it is eliminated" ],ES:[ "es eliminado", "es eliminada" ]
            }
        ];
                    ...
                    data:[
                        {
                            ...
                            by:{
                                ...
                                EN:"Inspired by the MD2 Rainbow Crossing quest \"Bear Hugs\"",ES:"Inspirado en la misión de MD2 Rainbow Crossing \"Bear Hugs\""
                            },
                            ...
                            versions:[
                                {
                                                ...
                                                guardian:[
                                                    {
                                                        ...
                                                        EN:[ "the Guardian", "the Guardian's Grip", "the Guardian's grip will eliminate it", "Deathgrip", "has become", "attacked or affected", "it", "has remained dormant", "has made it", "blinds it", "hit normally", "to free him" ],ES:[ "el Guardián", "la Garra del Guardián", "la garra del Guardián lo eliminará", "Garra Mortal", "se ha vuelto", "atacado o afectado", "lo", "ha permanecido dormido", "lo ha vuelto", "lo ciega", "golpeado con normalidad", "liberarlo" ]
                                                    },{
                                                        ...
                                                        EN:[ "the Creature", "the Creature's Grip", "the Creature's grip will eliminate it", "Fatal Grip", "has become", "attacked or affected", "it", "has remained dormant", "has made it", "blinds it", "hit normally", "to free it" ],ES:[ "la Criatura", "la Garra de la Criatura", "la garra de la Criatura lo eliminará", "Garra Fatal", "se ha vuelto", "atacada o afectada", "la", "ha permanecido dormida", "la ha vuelto", "la ciega", "golpeada con normalidad", "liberarla" ]
                                                    },{
                                                        ...
                                                        EN:[ "the Beast", "the Beast's Grip", "the Beast's grip will eliminate it", "Beast's Grip", "has become", "attacked or affected", "it", "left dormant", "has made it", "blinds it", "hit normally", "to free it" ],ES:[ "la Bestia", "la Garra de la Bestia", "la garra de la Bestia lo eliminará", "Garra Bestial", "se ha vuelto", "atacada o afectada", "la", "ha permanecido dormida", "la ha vuelto", "la ciega", "golpeada con normalidad", "liberarla" ]
                                                    }
                                                ],
                                                type:[
                                                    {
                                                        IT:[ "&egrave; una creatura solitamente pacifica ma," ],
                                                        EN:[ "is usually peaceful but," ],ES:[ "suele ser una criatura pacífica, pero," ]
                                                    },{
                                                        IT:[ "non ha mai lasciato il suo Regno ma," ],
                                                        EN:[ "has never left its Kingdom but," ],ES:[ "nunca ha abandonado su Reino, pero," ]
                                                    },{
                                                        IT:[ "&egrave; {label.guardian@7} in un lungo sonno ma ora," ],
                                                        EN:[ "{label.guardian@7} in a long sleep but now," ],ES:[ "{label.guardian@7} en un largo sueño, pero ahora," ]
                                                    }
                                                ],
                                                reason:[
                                                    {
                                                        IT:[ "a causa della corruzione Oscura," ],
                                                        EN:[ "due to the Dark corruption," ],ES:[ "debido a la corrupción de la Oscuridad," ]
                                                    },{
                                                        IT:[ "per qualche misterioso motivo," ],
                                                        EN:[ "for some mysterious reason," ],ES:[ "por algún misterioso motivo," ]
                                                    },{
                                                        IT:[ "dopo la Grande Guerra," ],
                                                        EN:[ "after the Great War," ],ES:[ "tras la Gran Guerra," ]
                                                    }
                                                ],
                                                effect:[
                                                    {
                                                        IT:[ "{label.guardian@4} terribilmente potente" ],
                                                        EN:[ "it {label.guardian@4} scaringly powerful" ],ES:[ "{label.guardian@4} terriblemente poderoso" ]
                                                    },{
                                                        IT:[ "una rabbia incontenibile {label.guardian@8} inarrestabile" ],
                                                        EN:[ "an uncontrollable rage {label.guardian@8} unstoppable" ],ES:[ "una rabia incontrolable {label.guardian@8} imparable" ]
                                                    },{
                                                        IT:[ "un implacabile desiderio di distruzione {label.guardian@9}" ],
                                                        EN:[ "a relentless desire for destruction {label.guardian@9}" ],ES:[ "un implacable deseo de destrucción {label.guardian@9}" ]
                                                    }
                                                ],
                                                spell:[
                                                    {
                                                        ...
                                                        EN:[ "break the Spell", "break the Spell that affects", "the Spell", "the Spell Gems", "a Spell Gem", "break the Spell that affects {label.guardian@6}", "all the Spell Gems" ],ES:[ "romper el Hechizo", "romper el Hechizo que afecta a", "el Hechizo", "las Gemas del Hechizo", "una Gema del Hechizo", "romper el Hechizo que {label.guardian@6} afecta", "todas las Gemas del Hechizo" ]
                                                    },{
                                                        ...
                                                        EN:[ "remove the Curse", "remove the Curse that affects", "the Curse", "the Curse Totems", "a Curse Totem", "remove the Curse that affects {label.guardian@6}", "all the Curse Totems" ],ES:[ "deshacer la Maldición", "deshacer la Maldición que afecta a", "la Maldición", "los Tótems de la Maldición", "un Tótem de la Maldición", "deshacer la Maldición que {label.guardian@6} afecta", "todos los Tótems de la Maldición" ]
                                                    },{
                                                        ...
                                                        EN:[ "cancel the Spell", "cancel the Spell that affects", "the Spell", "the Spell Spheres", "a Spell Sphere", "break the Spell that affects {label.guardian@6}", "all the Spell Spheres" ],ES:[ "anular el Conjuro", "anular el Conjuro que afecta a", "el Conjuro", "las Esferas del Conjuro", "una Esfera del Conjuro", "romper el Conjuro que {label.guardian@6} afecta", "todas las Esferas del Conjuro" ]
                                                    }
                                                ],
                                                hope:[
                                                    {
                                                        IT:[ "sperando {label.guardian@11} dalla morsa dell'Oscurit&agrave;!" ],
                                                        EN:[ "hoping {label.guardian@11} from the grip of the Darkness!" ],ES:[ "con la esperanza de {label.guardian@11} de las garras de la Oscuridad!" ]
                                                    },{
                                                        IT:[ "cercando di non rimetterci la pelle!" ],
                                                        EN:[ "trying not to lose our skin!" ],ES:[ "tratando de salvar el pellejo!" ]
                                                    },{
                                                        IT:[ "o altrimenti..." ],
                                                ...
                                                collectOptionalItems:[
                                                    {
                                                        ...
                                                        EN:[ "to eliminate {label.spell@6}", "eliminating all the Objective token on the colored side", "{tokensCount.objective}"],ES:[ "eliminar {label.spell@6}", "eliminando todos los marcadores de Objetivo con el lado de color hacia arriba", "{tokensCount.objective}" ]
                                                    }
                                                ]
                                            }
                                        ]
                                    ...
                                    title:[
                                        {
                                            EN:"{label.guardian:capital@3}",ES:"{label.guardian:capital@3}"
                                        },{
                                            EN:"{label.spell:capital@0}",ES:"{label.spell:capital@0}"
                                        },{
                                            EN:"{label.spell:capital@3}",ES:"{label.spell:capital@3}"
                                        }
                                    ],
                                    story:[
                                        {
                                            IT:"{label.guardian:capital@0} {label.type@0} {label.reason@0} {label.effect@0}. Gli Eroi devono {label.spell@5}, {label.hope@0}",
                                            EN:"{label.guardian:capital@0} {label.type@0} {label.reason@0} {label.effect@0}. Heroes must {label.spell@5}, {label.hope@0}",ES:"{label.guardian:capital@0} {label.type@0} {label.reason@0} {label.effect@0}. Los Héroes deben {label.spell@5}, {label.hope@0}"
                                        }
                                    ],
                                    objectivesHeader:[
                                        {
                                        ...
                                        [
                                            {
                                                ...
                                                summary:[
                                                    {
                                                        EN:"{label.spell:capital@1} {label.guardian@0}",ES:"{label.spell:capital@1} {label.guardian@0}"
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        EN:"Generate a Level 5 Roaming Monster in the Corruption token {symbol.corruptionToken} Zone and remove that token. This is {label.guardian@0}.",ES:"Genera un Monstruo Errante de nivel 5 en la Zona marcada con el marcador de Corrupción {symbol.corruptionToken} y retira ese marcador. Se trata de {label.guardian@0}."
                                                    }
                                                ],
                                                campaignExplanation:[
                                                    {
                                                        ...
                                                        EN: "Spawn {label.campaignBoss@0} in the Corruption token {symbol.corruptionToken} Zone and remove that token. This is {label.guardian@0}.",ES:"Genera {label.campaignBoss@0} en la Zona marcada con el marcador de Corrupción {symbol.corruptionToken} y retira ese marcador. Se trata de {label.guardian@0}."
                                                    }
                                                ]
                                            }
                                        ],[
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        EN:"If {label.collectOptionalItems@2} Objective tokens on the colored side haven't been removed, {label.guardian@0} cannot be {label.guardian@5} by any ability or effect, Heroes cannot enter its Zone, and at the start of each Enemy Phase {label.guardian@0} moves 2 Zones toward the closest Hero. If {label.guardian@0} enters a Hero's Zone, {label.guardian@2} and the Mission ends in defeat.",ES:"Si no se han retirado {label.collectOptionalItems@2} marcadores de Objetivo con el lado de color hacia arriba, {label.guardian@0} no puede ser {label.guardian@5} por ninguna habilidad o efecto, los Héroes no pueden entrar en su Zona y, al principio de cada Fase de los Enemigos, {label.guardian@0} se mueve 2 Zonas hacia el Héroe más cercano. Si {label.guardian@0} entra en la Zona de un Héroe, {label.guardian@2} y la Misión termina en derrota."
                                                    }
                                                ]
                                            }
                                        ],[
                                            {
                                                ...
                                                name:[
                                                    {
                                                        EN:"{label.spell:capital@2}",ES:"{label.spell:capital@2}"
                                                    }
                                                ],
                                                explanation:[
                                                    {
                                                        ...
                                                        EN:"The Objective tokens on the colored side represent {label.spell@3}. Any Hero in {label.spell@4}'s Zone can spend 1 action to discard the token. Each time a token is discarded, all Heroes gets 5 XP. Once {label.collectOptionalItems@2} Objective tokens on the colored side have been removed, {label.guardian@0} can be {label.guardian@10}.",ES:"Los marcadores de Objetivo con el lado de color hacia arriba representan {label.spell@3}. Cualquier Héroe en la Zona de {label.spell@4} puede gastar 1 acción para descartar el marcador. Cada vez que se descarta un marcador, todos los Héroes ganan 5 PE. Una vez que se hayan retirado {label.collectOptionalItems@2} marcadores de Objetivo con el lado de color hacia arriba, {label.guardian@0} puede ser {label.guardian@10}."
                                                    }
                                                ],
                                                campaignExplanation:[
                                                    {
                                                        ...
                                                        EN:"The Objective tokens on the colored side represent {label.spell@3}. Any Hero in {label.spell@4}'s Zone can spend 1 action to discard the token. Once {label.collectOptionalItems@2} Objective tokens on the colored side have been removed, {label.guardian@0} can be {label.guardian@10}.",ES:"Los marcadores de Objetivo con el lado de color hacia arriba representan {label.spell@3}. Cualquier Héroe en la Zona de {label.spell@4} puede gastar 1 acción para descartar el marcador. Una vez que se hayan retirado {label.collectOptionalItems@2} marcadores de Objetivo con el lado de color hacia arriba, {label.guardian@0} puede ser {label.guardian@10}."
                                                    }
                                                ],
                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        EN:"If the heroes defeat {label.guardian:capital@0} {label.questVictory@0}.",ES:"Si los héroes derrotan a {label.guardian@0}, {label.questVictory@0}."
                                                    }
                                                ]
                                            }
                                        ]
